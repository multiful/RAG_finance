# ======================================================================
# FSC Policy RAG System | 모듈: app.constants.kai_targets
# 최종 수정일: 2026-04-07
...
# 목표 지표 (page_29 핵심 성과 지표 + 평가 지표 상세)
...
KAI_COMPLETENESS_MIN_PCT = 90.0         # 완전성 > 90% (page_29 평가 지표 상세, 목표는 문서에 수치 미명시)
...
KAI_TARGETS: Dict[str, Dict[str, Any]] = {
    ...
    "completeness_pct": {
        "target_value": KAI_COMPLETENESS_MIN_PCT,
        "operator": "gt",
        "unit": "%",
        "label_ko": "완전성",
        "description_ko": "관련 법령을 누락 없이 모두 식별하는 비율. (page_29 평가 지표 상세)",
        "source": "page_29 평가 지표 상세",
    },
}
...
def get_kai_targets_summary() -> Dict[str, Any]:
    ...
    return {
        ...
        "numeric_limits": {
            ...
            "completeness_min_pct": KAI_COMPLETENESS_MIN_PCT,
        },
    }
